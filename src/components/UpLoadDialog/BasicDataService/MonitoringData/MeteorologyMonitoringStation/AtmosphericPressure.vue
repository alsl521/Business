  ...
  <el-dialog v-model="upLoadDialogStore.AtmosphericPressureDialogVisible" destroy-on-close>
    ...
    <div v-if="showPages==2">
      <el-form ref="ruleFormRef" :model="form" label-width="120px" style="margin-top: 20px" :rules="rules">
        ...
        <el-form-item label="AP(mbar)" prop="observation_atmosphericpressure">
    ...
    <div v-if="showPages==3">
      ...
      <el-table :data="observation_Data" style="width: 100%;margin-top: 10px" border height="200">
        ...
        <el-table-column prop="atmosphericpressure" label="Atmospheric(mbar)"/>
        <el-table-column label="Operations">
          <template #default="scope">
      ...
      >
        ...
        <el-form :model="Observation_Data_Modification_FormValue" label-width="120px" style="margin-top: 30px">
          ...
          <el-form-item label="Atmospheric(mbar)">
            <el-input v-model="Observation_Data_Modification_FormValue.Atmospheric"/>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="updateLocal">修改</el-button>
          </el-form-item>
...
const handle_Observation_Data_Edit = (index: number, row: any) => {
  ...
  Observation_Data_Modification_FormValue.Atmospheric = row.Atmospheric
...
const updateLocal = async () => {
  if (Monitoring_Point_Attribute_Modification_Visible.value == true) {
    ...
    observation_Data.value[Observation_Data_Modification_FormValue.index].Atmospheric = Observation_Data_Modification_FormValue.Atmospheric
