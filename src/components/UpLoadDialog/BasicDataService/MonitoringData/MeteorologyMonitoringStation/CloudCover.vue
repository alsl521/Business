<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.CloudCoverDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
...
<!--      <el-button type="primary" @click="getCloudCover">-->
<!--        加载已有数据-->
<!--      </el-button>-->
...
<!--        <el-form-item label="云量(％)" prop="observation_cloudcover">-->
<!--          <el-select v-model="form.observation_cloudcover" placeholder="请选择云量字段">-->
<!--            <el-option-->
<!--                v-for="item in file_options"-->
<!--                :key="item"-->
<!--                :label="item"-->
...
<!--      <el-text size="large" type="primary">云量监测点属性表</el-text>-->
...
<!--      <el-button type="primary" style="margin-top: 20px" @click="publishCloudCover">-->
<!--        确定-->
<!--      </el-button>-->
...
<!--            <el-input v-model="Observation_Data_Modification_FormValue.cloudcover"/>-->
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button type="primary" @click="updateLocal">修改</el-button>-->
<!--          </el-form-item>-->
...
<!--<script setup lang="ts" name="CloudCoverDialog">-->
...
<!--  await upLoadDialogStore.get_CloudCover_Data();-->
<!--}-->
...
<!--    let result: any = await upLoadDialogStore.upLoad_CloudCover_Data(formData)-->
<!--    if (result.code == 1) {-->
<!--      showPages.value = 2-->
...
<!--      let result: any = await upLoadDialogStore.create_CloudCover_Table(form)-->
...
<!--  Observation_Data_Modification_FormValue.cloudcover = row.cloudcover-->
...
<!--    let result: any = await upLoadDialogStore.update_CloudCover_Table(Monitoring_Point_Attribute_Modification_FormValue)-->
<!--    if (result.code == 1) {-->
...
<!--    observation_Data.value[Observation_Data_Modification_FormValue.index].cloudcover = Observation_Data_Modification_FormValue.cloudcover-->

<!--    let result: any = await upLoadDialogStore.update_CloudCover_Table(Observation_Data_Modification_FormValue)-->
<!--    if (result.code == 1) {-->
...
<!--const publishCloudCover = async () => {-->
<!--  let result: any = await upLoadDialogStore.publish_CloudCover_Data()-->

<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.CloudCoverDialogVisible = false-->
<!--  }-->
<!--}-->
<!--</script>-->
