<template>
  <el-dialog v-model="upLoadDialogStore.EFDCInitialWaterLevelDialogVisible" destroy-on-close>
    <!-- 自定义标题栏 -->
...
<script setup lang="ts" name="HEFDCInitialWaterLevelDialog">
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_EFDCInitialWaterLevel_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.EFDCInitialWaterLevelDialogVisible= false
  } else {
    isLoading.value = false;
  }
}
