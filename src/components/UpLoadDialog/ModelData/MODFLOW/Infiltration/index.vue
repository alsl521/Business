<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.MODFLOWInfiltrationDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "MODFLOW-渗透（水力传导）" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--<script setup lang="ts" name="MODFLOWInfiltrationDialog">-->
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_Infiltration_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.MODFLOWInfiltrationDialogVisible= false
  } else {
    isLoading.value = false;
  }
}
