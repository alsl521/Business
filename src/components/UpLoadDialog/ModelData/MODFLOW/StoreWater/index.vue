<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.MODFLOWStoreWaterDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "MODFLOW-贮水（给水度）" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--<script setup lang="ts" name="MODFLOWStoreWaterDialog">-->
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_StoreWater_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.MODFLOWStoreWaterDialogVisible = false
  } else {
    isLoading.value = false;
  }
}
