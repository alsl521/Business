<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMJunctionParameterDispersionDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
...
<!--<script setup lang="ts" name="SWMMJunctionParameterDispersionDialog">-->
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_ModelData_SWMM_ParameterDiscrete_Junction_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.SWMMJunctionParameterDispersionDialogVisible = false
  } else {
    isLoading.value = false;
  }
}
