<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMRainGaugeParameterDispersionDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
...
<!--<script setup lang="ts" name="SWMMRainGaugeParameterDispersionDialog">-->
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_ModelData_SWMM_ParameterDiscrete_RainGauge_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.SWMMRainGaugeParameterDispersionDialogVisible = false
  } else {
    isLoading.value = false;
  }
}
