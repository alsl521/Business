<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMJunctionSpatialDispersionDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
...
<!--<script setup lang="ts" name="SWMMJunctionSpatialDispersionDialog">-->
...
<script setup lang="ts" name="SWMMJunctionSpatialDispersionDialogVisible">
...
const submitUpload = async () => {
  ...
  let result: any = await upLoadDialogStore.upLoad_ModelData_SWMM_SpatialDiscrete_Junction_Data(formData)
  if (result.code == 1) {
    ...
    upLoadDialogStore.SWMMJunctionSpatialDispersionDialogVisible = false
  } else {
    isLoading.value = false;
  }
}
