<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMRainGaugeSpatialDispersionDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
...
<!--        <el-table-column prop="name" label="雨量计名称"/>-->
...
<!--<script setup lang="ts" name="SWMMRainGaugeSpatialDispersionDialog">-->
...
<!--  let result: any = await upLoadDialogStore.upLoad_ModelData_SWMM_SpatialDiscrete_RainGauge_Data(formData)-->
<!--  if (result.code == 1) {-->
<!--    showPages.value = 2-->
...
<!--  let result: any = await upLoadDialogStore.create_ModelData_SWMM_SpatialDiscrete_RainGauge_Table(form)-->
...
<!--  let result: any = await upLoadDialogStore.update_ModelData_SWMM_SpatialDiscrete_RainGauge_Table(formValue)-->
<!--  console.log(result)-->
<!--  if (result.code == 1) {-->
...
<!--  let result: any = await upLoadDialogStore.publish_ModelData_SWMM_SpatialDiscrete_RainGauge_Data()-->
<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.SWMMRainGaugeSpatialDispersionDialogVisible = false-->
<!--  }-->
<!--}-->
