<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.EFDCSpatialDiscreteDataDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "空间离散数据-EFDC空间离散" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--        </el-table-column>-->
<!--      </el-table>-->
<!--      <el-button type="primary" style="margin-top: 20px" @click="publish_EFDCSpatialDiscreteData">-->
<!--        确定-->
<!--      </el-button>-->
...
<!--<script setup lang="ts" name="EFDCSpatialDiscreteDataDialog">-->
...
<!--  let result: any = await upLoadDialogStore.upLoad_EFDCSpatialDiscreteData_Data(formData)-->
<!--  if (result.code == 1) {-->
<!--    showPages.value = 2-->
...
<!--  let result: any = await upLoadDialogStore.create_EFDCSpatialDiscreteData_Table(form)-->
<!--  if (result.code == 1) {-->
...
<!--  let result: any = await upLoadDialogStore.update_EFDCSpatialDiscreteData_Table(formValue)-->
<!--  console.log(result)-->
<!--  if (result.code == 1) {-->
...
<!--const publish_EFDCSpatialDiscreteData = async () => {-->
<!--  let result: any = await upLoadDialogStore.publish_EFDCSpatialDiscreteData_Data()-->
<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.EFDCSpatialDiscreteDataDialogVisible = false-->
<!--  }-->
<!--}-->
