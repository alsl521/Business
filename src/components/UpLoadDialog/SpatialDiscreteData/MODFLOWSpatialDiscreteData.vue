<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.MODFLOWSpatialDiscreteDataDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "空间离散数据-MODFLOW空间离散" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--        </el-table-column>-->
<!--      </el-table>-->
<!--      <el-button type="primary" style="margin-top: 20px" @click="publish_MODFLOWSpatialDiscreteData">-->
<!--        确定-->
<!--      </el-button>-->
...
<!--  let result: any = await upLoadDialogStore.upLoad_MODFLOWSpatialDiscreteData_Data(formData)-->
<!--  if (result.code == 1) {-->
<!--    showPages.value = 2-->
...
<!--  let result: any = await upLoadDialogStore.create_MODFLOWSpatialDiscreteData_Table(form)-->
<!--  if (result.code == 1) {-->
...
<!--  let result: any = await upLoadDialogStore.update_MODFLOWSpatialDiscreteData_Table(formValue)-->
<!--  console.log(result)-->
<!--  if (result.code == 1) {-->
...
<!--const publish_MODFLOWSpatialDiscreteData = async () => {-->
<!--  console.log("SSS")-->

<!--  let result: any = await upLoadDialogStore.publish_MODFLOWSpatialDiscreteData_Data()-->

<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.MODFLOWSpatialDiscreteDataDialogVisible = false-->
<!--  }-->
<!--}-->
