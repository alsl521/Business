<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMSpatialDiscreteDataDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "空间离散数据-SWMM空间离散" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--        </el-table-column>-->
<!--      </el-table>-->
<!--      <el-button type="primary" style="margin-top: 20px" @click="publish_SWMMSpatialDiscreteData">-->
<!--        确定-->
<!--      </el-button>-->
...
<!--<script setup lang="ts" name="SWMMSpatialDiscreteDataDialog">-->
<!--import {reactive, ref} from 'vue'-->
<!--import {ElMessage, type FormRules, genFileId} from 'element-plus'-->
...
<!--  let result: any = await upLoadDialogStore.upLoad_SWMMSpatialDiscreteData_Data(formData)-->
<!--  if (result.code == 1) {-->
<!--    showPages.value = 2-->
...
<!--  let result: any = await upLoadDialogStore.create_SWMMSpatialDiscreteData_Table(form)-->
...
<!--  let result: any = await upLoadDialogStore.update_SWMMSpatialDiscreteData_Table(formValue)-->
<!--  console.log(result)-->
<!--  if (result.code == 1) {-->
...
<!--const publish_SWMMSpatialDiscreteData = async () => {-->
<!--  let result: any = await upLoadDialogStore.publish_SWMMSpatialDiscreteData_Data()-->
<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.SWMMSpatialDiscreteDataDialogVisible = false-->
<!--  }-->
<!--}-->
