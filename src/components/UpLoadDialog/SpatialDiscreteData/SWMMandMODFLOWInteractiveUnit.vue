<!--<template>-->
<!--  <el-dialog v-model="upLoadDialogStore.SWMMandMODFLOWInteractiveUnitDialogVisible" destroy-on-close>-->
<!--    &lt;!&ndash; 自定义标题栏 &ndash;&gt;-->
<!--    <template #header="{ titleId, titleClass }">-->
<!--      <div class="my-header">-->
<!--        <h4>{{ "空间离散数据-SWMM-MODFLOW交互单元" }}</h4>-->
<!--      </div>-->
<!--    </template>-->
...
<!--        <el-form-item label="MODFLOW单元序列" prop="cellindex">-->
<!--          <el-select v-model="form.cellindex" placeholder="请选择MODFLOW单元序列字段">-->
<!--            <el-option-->
<!--                v-for="item in options"-->
<!--                :key="item.name"-->
<!--                :label="item.name"-->
...
<!--        <el-table-column prop="cellindex" label="MODFLOW单元序列"/>-->
...
<!--        </el-table-column>-->
<!--      </el-table>-->
<!--      <el-button type="primary" style="margin-top: 20px" @click="publish_SWMMandMODFLOWInteractiveUnit">-->
<!--        确定-->
<!--      </el-button>-->
...
<!--<script setup lang="ts" name="SWMMandMODFLOWInteractiveUnitDialog">-->
...
<!--  let result: any = await upLoadDialogStore.upLoad_SWMMandMODFLOWInteractiveUnit_Data(formData)-->
<!--  if (result.code == 1) {-->
<!--    showPages.value = 2-->
...
<!--  let result: any = await upLoadDialogStore.create_SWMMandMODFLOWInteractiveUnit_Table(form)-->
...
<!--  let result: any = await upLoadDialogStore.update_SWMMandMODFLOWInteractiveUnit_Table(formValue)-->
<!--  console.log(result)-->
<!--  if (result.code == 1) {-->
...
<!--const publish_SWMMandMODFLOWInteractiveUnit = async () => {-->
<!--  let result: any = await upLoadDialogStore.publish_SWMMandMODFLOWInteractiveUnit_Data()-->
<!--  if (result.code == 1) {-->
<!--    upLoadDialogStore.SWMMandMODFLOWInteractiveUnitDialogVisible = false-->
<!--  }-->
<!--}-->
